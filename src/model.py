"""
Loss Functions Explained - Model Architecture
"""
import torch
...
class LossFunctionsExplained(nn.Module):
    """
    Main model for loss functions explained.
    """
...
def build_model(config):
    model = LossFunctionsExplained(config)
