"""
Loss Functions Explained - Dataset
"""
import os
import torch
...
class LossFunctionsExplainedDataset(Dataset):
    """Dataset for loss functions explained."""
...
def get_dataloader(root, split, config):
    ...
    dataset = LossFunctionsExplainedDataset(root, split, transform)
    return DataLoader(
        dataset,
